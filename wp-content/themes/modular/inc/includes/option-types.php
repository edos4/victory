...
function modular_action_theme_include_custom_option_types() {
	if ( is_admin() ) {
		$dir = MODULAR_INC . '/includes';
...
add_action( 'fw_option_types_init', 'modular_action_theme_include_custom_option_types' );
